  ...
  return (
    <div className="min-h-screen bg-[#F5F5F0] flex items-center justify-center p-4 font-serif">
      ...
      >
        ...
        <h1 className="text-3xl font-bold text-center text-[#1A1A1A] mb-2">Welcome Back</h1>
        <p className="text-center text-[#5A5A40]/60 mb-8 italic">Manage your workforce with elegance</p>
        ...
        <div className="mt-8 text-center">
          <Link to="/register" className="text-[#5A5A40] hover:underline underline-offset-8 transition-all">
