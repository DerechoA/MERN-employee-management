...
router.patch('/:model/:id/undelete', authMiddleware, authorizeRoles('admin'), undeleteModelItem);
router.delete('/:model/:id/permanent', authMiddleware, authorizeRoles('admin'), permanentDeleteModelItem);
