...
A clean, minimal MERN application (React + Express + MongoDB) with **user authentication (JWT)** and **employee CRUD**.
...
If you want the app to support **multiple user roles** (admin / normal user), I can add role-based access back in with a few tweaks.
